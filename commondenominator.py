...
def getUsers(context=None):
  ...
  blacklist = [xchat.get_info("nick"), "__main__", "__class__"]

  return [u.nick for u in users if u.nick not in blacklist]

xchat.prnt("Common Denominator script initialized")
xchat.prnt("Use /comden to find common denominators in a channel")
